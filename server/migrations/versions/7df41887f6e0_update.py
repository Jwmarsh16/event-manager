...
Revision ID: 7df41887f6e0
Revises: 
Create Date: 2024-11-27 21:22:18.234630
...
def upgrade():
    ...
    sa.Column('event_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk_event_invitation_event_id_events')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_event_invitation_user_id_users')),
    sa.PrimaryKeyConstraint('event_id', 'user_id', name=op.f('pk_event_invitation'))
    )
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_event_invitations'))
    )
    ...
    sa.ForeignKeyConstraint(['inviter_id'], ['users.id'], name=op.f('fk_group_invitations_inviter_id_users')),
